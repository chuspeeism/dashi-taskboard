...
const COMMAND_OPTIONS = new Map([
  ...
  ["project create", new Set(["id", "name", "area", "workspace-path", "json"])],
...
Commands:
  ...
  project list
  project create --name NAME [--id ID] [--area AREA] [--workspace-path PATH]
  ...
  switch (command) {
    ...
    case "project create":
      ...
      return api.request("POST", "/api/projects", {
        ...
        ...optionalField("area", parsed.options.area),
        ...optionalField(
          "workspacePath",
