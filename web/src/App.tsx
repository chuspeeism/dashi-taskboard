...
export function App() {
  ...
  // Host context is refreshed every second. Keep this object stable unless the fields sent to the
  // automation host actually change, otherwise the status effect would issue a list request on
  // every heartbeat.
