...
| --- | --- | --- |
| local companion / loopback companion | 本機 companion、本機配套服務、環回代理 | 伴侶、伴侶 API |
| Taskboard HTTP API (`/api/tasks`, `/api/comments`, `/api/attachments`, …) | Taskboard HTTP API、本機服務 API、附件上傳介面 | companion API、伴侶 API |
